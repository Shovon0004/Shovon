...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Shovon Halder', url: 'https://shovon-halder.com' }],
  ...
  twitter: {
    ...
    images: ['https://shovon-halder.com/og-image.png'],
  },
  appleWebApp: {
    capable: true,
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://shovon-halder.com" />
        
        {/* Alternate Versions */}
        <link rel="alternate" hrefLang="en" href="https://shovon-halder.com" />
        ...
        <meta property="og:url" content="https://shovon-halder.com" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'Shovon Halder',
              url: 'https://shovon-halder.com',
              logo: 'https://shovon-halder.com/logo.png',
